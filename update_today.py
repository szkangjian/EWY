"""
从 Yahoo Finance 获取今天的 STRC 1分钟数据，追加到主数据库 CSV
"""
import yfinance as yf
import pandas as pd

MAIN_CSV = "strc_minute_data.csv"

print("📥 从 Yahoo Finance 获取今天的 STRC 1分钟数据...")
data = yf.download("STRC", period="1d", interval="1m")
